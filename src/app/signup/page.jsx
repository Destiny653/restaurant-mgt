                        ...
                        {formData.role === 'Staff' && (
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`mt-1 block w-full rounded-md border ${errors.salary ? 'border-red-500' : 'border-gray-300'
                                        } px-3 py-2 shadow-sm focus:border-yellow-500 focus:outline-none focus:ring-yellow-500 sm:text-sm`}
                                />
                                {errors.salary && (
                        ...
                        <div>
                            ...
                            <div className="relative mt-1">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`block w-full rounded-md border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'
                                        } px-3 py-2 pr-10 shadow-sm focus:border-yellow-500 focus:outline-none focus:ring-yellow-500 sm:text-sm`}
                                />
                                <button
                                    type="button"
                    ...
                    <div className="mb-8">
                        <div className="flex justify-between mb-2">
                            {['Personal Info', 'Account Details', 'Terms'].map((step, index) => (
                                <span
                                    key={step}
                                    className={`text-sm font-medium ${index + 1 <= currentStep ? 'text-yellow-600' : 'text-gray-400'
                                        }`}
                                >
                                    {step}
                                </span>
