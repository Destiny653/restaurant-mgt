...
export default function Checkout() {
  const { state } = useCart();
  const [currentStep] = useState(2); // For demo, showing payment step
        ...
        <div className="gap-8 grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            <div className="top-24 sticky bg-white shadow-sm p-6 rounded-xl">
              ...
              <button
                className="bg-blue-600 hover:bg-blue-700 mt-6 px-6 py-4 rounded-lg focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 w-full font-medium text-white transition-colors focus:outline-none"
